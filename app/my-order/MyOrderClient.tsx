                    ...
                    {detail.estimates.map(e => (
                      <div key={e.id} className="p-4">
                        <div className="flex justify-between items-start mb-1">
                          <div>
                            <p className="font-semibold text-gray-900">{e.businessName}</p>
                            <p className="text-xs text-gray-400">{e.equipmentType} · 예상 {e.estimatedDays || '-'}일</p>
                          </div>
                          <p className="text-lg font-bold text-blue-600">{fmtAmount(e.amount)}</p>
                        </div>
                        {e.description && <p className="text-sm text-gray-600 mt-1 mb-3 leading-relaxed">{e.description}</p>}
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className="flex-2 bg-blue-600 text-white px-5 py-2 rounded-xl text-sm font-semibold hover:bg-blue-700 transition-colors">
                            선택하기
                          </button>
                        </div>
                      </div>
